...
tmp/NTTData-1.0-SNAPSHOT.jar Hdfs_into_postgres hdfs://192.168.182.6:8020/hive/warehouse/hive/warehouse/ecom1.db/customers_dataset/customers_dataset.csv
"""
with DAG(
    dag_id='ssh_operator',
